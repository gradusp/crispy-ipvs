...
func RegisterIpvsAdminHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IpvsAdminServer) error {
	...
	mux.Handle("POST", pattern_IpvsAdmin_FindVirtualServer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/FindVirtualServer", runtime.WithHTTPPathPattern("/v2/ipvs/virtual-server/find"))
		if err != nil {
	...
	mux.Handle("POST", pattern_IpvsAdmin_ListVirtualServers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/ListVirtualServers", runtime.WithHTTPPathPattern("/v2/ipvs/virtual-servers/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_IpvsAdmin_UpdateVirtualServers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/UpdateVirtualServers", runtime.WithHTTPPathPattern("/v2/ipvs/virtual-servers/update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_IpvsAdmin_UpdateRealServers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/UpdateRealServers", runtime.WithHTTPPathPattern("/v2/ipvs/real-servers/update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterIpvsAdminHandlerClient(ctx context.Context, mux *runtime.ServeMux, client IpvsAdminClient) error {
	...
	mux.Handle("POST", pattern_IpvsAdmin_FindVirtualServer_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/FindVirtualServer", runtime.WithHTTPPathPattern("/v2/ipvs/virtual-server/find"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_IpvsAdmin_ListVirtualServers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/ListVirtualServers", runtime.WithHTTPPathPattern("/v2/ipvs/virtual-servers/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_IpvsAdmin_UpdateVirtualServers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/UpdateVirtualServers", runtime.WithHTTPPathPattern("/v2/ipvs/virtual-servers/update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_IpvsAdmin_UpdateRealServers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/crispy.ipvs.IpvsAdmin/UpdateRealServers", runtime.WithHTTPPathPattern("/v2/ipvs/real-servers/update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
